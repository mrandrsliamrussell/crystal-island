...
Shader "Custom/ Grass_shader_merged" {
	Properties{
...
#pragma target 3.0
	...
	VertexOutput vert(VertexInput v) {
		...
		half offsetVert = -(v.vertex.y * v.vertex.y);
		half value = (_Scale / 100) * sin(_Time.w * _Speed + offsetVert * (_Frequency));
		v.vertex.z += value * _OffsetX;
